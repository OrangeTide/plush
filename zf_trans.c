...
**                         Plush Version 1.0                                 **
**                                                                           **
**                  Translucent Z-Buffering Rasterizers                      **
**                                                                           **
...
void plPF_TransGZB(pl_CameraType *cam, pl_FaceType *TriFace) {
  unsigned char *gmem = cam->frameBuffer;
  pl_ZBufferType *zbuf = cam->zBuffer;
  pl_VertexType *sp[3];
  pl_sInt32Type X1, X2, dX1, dX2, XL1, XL2;
